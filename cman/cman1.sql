...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2023 at 06:51 PM
...
(23, 'admin', '2023-01-30 03:52:06', 'Added member 0243652178'),
(24, 'admin', '2023-01-30 16:18:09', 'Added member 0507756300'),
(25, 'admin', '2023-01-30 16:32:10', 'Added member 0507756300'),
(26, 'admin', '2023-01-30 16:41:28', 'Added member 0507756300');
...
(3, 'Elbernard', 'Owusu', 'admin', '1234', 'uploads/IMG_20201011_103443_679.jpg');
...
(5, 'Thanksgiving', '2023-02-01', 'Praises & worship');
...
INSERT INTO `members` (`keyu`, `fname`, `sname`, `lname`, `Gender`, `Birthday`, `Residence`, `pob`, `ministry`, `mobile`, `email`, `thumbnail`, `level`, `id`, `date`) VALUES
(9, 'Joseph', 'Adu', 'Boahen', 'Male', '2023-02-04', 'Atwima', 'Kumasi', 'Lectors', '0243652178', 'boahen@gmail.com', 'uploads/none.png', '0000', '0243652178', '2023-01-30 03:52:06'),
(12, 'Asare', 'Paul', 'Tando', 'Male', '2023-02-02', 'Opoku Ware Hall', 'Kumasi', 'Ushering', '0507756300', 'john@gmail.com', 'uploads/none.png', '100', '0507756300', '2023-01-30 16:41:28');
...
--
ALTER TABLE `giving`
  MODIFY `givingid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `members`
--
ALTER TABLE `members`
  MODIFY `keyu` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tithe`
  MODIFY `titheid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
