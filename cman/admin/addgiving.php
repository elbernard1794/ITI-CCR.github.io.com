    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_user=mysqli_query($conn,"select Amount,Trcode,paytime,na,ya from giving");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select Amount,Trcode,paytime,na,ya from giving ")or die(mysqli_error());
