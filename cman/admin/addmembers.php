...
<div class="block-content collapse in">
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="lname" id="focusedInput" type="text" placeholder = "Last name"> 
                                   </p>
                                 </div>
                                  </div>
								  <div class="control-group">
  ...
  <option value="Sunday School">Sunday School</option>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="level" id="focusedInput" type="text" placeholder = "Level" required> 
                                   </p>
                                 </div>
                                  </div>
								  </p>
...
mysqli_query($conn,"insert into members (fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,email,thumbnail,level,id) 
values('$fname','$sname','$lname','$Gender','$birthday','$residence','$pob','$ministry','$mobile','$email','uploads/none.png','$level','$mobile')")or die(mysqli_error());
