   ...
   <script type="text/javascript">
	...
	$('#add').tooltip('hide');
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="level" id="focusedInput" value="<?php echo $row['level']; ?>" type="text" placeholder = "password " required> 
                                   </p>
                                 </div>
                                  </div>
								  </p>
...
mysqli_query($conn,"UPDATE members SET fname = '$fname',sname ='$sname',lname='$lname',Gender='$Gender',Birthday='$birthday', Residence='$residence',pob='$pob',ministry='$ministry',mobile='$mobile',email='$email',level='$level' where id='$get_member_id'") 
or die(mysqli_error());
